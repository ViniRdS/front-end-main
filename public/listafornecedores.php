...
<body>
    ...
    <!-- Modal -->
    <div class="modal fade" id="cadastrofornecedor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" name="frmfornecedor" id="frmfornecedor">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <button id="btncadastro" type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#cadastrofornecedor">
